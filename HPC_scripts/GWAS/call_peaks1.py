...
min_snps_per_peak = int(sys.argv[5])
...
colnames = ["SNP", "CHROM", "POS", "REF", "ALT", "MAF", "Effect", "SE", "pval"]
significant_snps.columns = colnames
...
top_snps_per_peak = significant_snps.loc[significant_snps.groupby('peak_id')['pval'].idxmin()].rename(
    columns={'SNP': 'top_SNP', 'pval': 'top_Pvalue'})[['peak_id', 'CHROM', 'POS', 'top_SNP', 'top_Pvalue']]
